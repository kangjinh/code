...
namespace JuCheap.Services
{
    ...
    public class JuCheapModuleInitializer : ModuleInitializer
    {
        ...
        {
            config.CreateMap<StaffEntity, UserDto>().ReverseMap();
            config.CreateMap<StaffEntity, UserAddDto>().ReverseMap();
            config.CreateMap<StaffEntity, UserUpdateDto>().ReverseMap();
